...
@NonNullApi
public class PassiveDataComposeProjectDependency extends DelegatingProjectDependency {

    @Inject
    public PassiveDataComposeProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
