...
public final class FragmentDashboardBinding implements ViewBinding {
  ...
  private FragmentDashboardBinding(@NonNull FrameLayout rootView,
      @NonNull FrameLayout dashboardContainer) {
  ...
  public static FragmentDashboardBinding bind(@NonNull View rootView) {
    ...
    FrameLayout dashboardContainer = (FrameLayout) rootView;

    return new FragmentDashboardBinding((FrameLayout) rootView, dashboardContainer);
  }
}
